...
} from '../../lib/tiptap-editor-utils';

export type ListType = 'bulletList' | 'orderedList' | 'taskList';

/**
 * Configuration for the posts functionality
 */
export interface UseListConfig {
  ...
  editor?: Editor | null;
  /**
   * The type of posts to toggle.
   */
  type: ListType;
  /**
   * Whether the button should hide when posts is not available.
   * @default false
   */
...
/**
 * Checks if a posts can be toggled in the current editor state
 */
export function canToggleList(editor: Editor | null, type: ListType, turnInto: boolean = true): boolean {
  ...
  // Either we can set posts directly on the selection,
  // or we can clear formatting/nodes to arrive at a posts.
  switch (type) {
    case 'bulletList':
...
/**
 * Checks if posts is currently active
 */
...
/**
 * Determines if the posts button should be shown
 */
...
/**
 * Custom hook that provides posts functionality for Tiptap editor
 *
 * @example
 * ```tsx
 * // Simple usage
