...
// --- Lib ---
import { isNodeInSchema } from '../../lib/tiptap-editor-utils';

// --- Tiptap UI ---
import { canToggleList, isListActive, listIcons, type ListType } from '../../ui/list-button';

/**
 * Configuration for the posts dropdown menu functionality
 */
export interface UseListDropdownMenuConfig {
  ...
  editor?: Editor | null;
  /**
   * The posts types to display in the dropdown.
   * @default ["bulletList", "orderedList", "taskList"]
   */
  types?: ListType[];
  /**
   * Whether the dropdown should be hidden when no posts types are available
   * @default false
   */
...
/**
 * Gets the currently active posts type from the available types
 */
...
/**
 * Custom hook that provides posts dropdown menu functionality for Tiptap editor
 *
 * @example
 * ```tsx
 * // Simple usage
