...
// --- Lib ---
import { cn, parseShortcutKeys } from '../../lib/tiptap-editor-utils';

import '../../ui-primitive/button/button-colors.scss';
import '../../ui-primitive/button/button-group.scss';
import '../../ui-primitive/button/button.scss';
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, children, tooltip, showTooltip = true, shortcutKeys, 'aria-label': ariaLabel, ...props }, ref) => {
    ...
    if (!tooltip || !showTooltip) {
      return (
        <button type={'button'} className={cn('tiptap-button', className)} ref={ref} aria-label={ariaLabel} {...props}>
          {children}
        </button>
      );
    }
