...
import '../../nodes/image-upload-node/image-upload-node.scss';
import { focusNextNode, isValidPosition } from '../../lib/tiptap-editor-utils';
...
const DropZoneContent = () => (
  <button type={'button'} className={'border py-10 rounded-lg w-full'}>
