...
import type { PostData, PostFormData } from 'apis';
import { Button } from 'components';
import { createPost, updatePost } from '@/app/(protected)/_libs/posts';
...
const PostForm = ({ initialPost, menuOptions, id, isNew }: PostFormProps) => {
