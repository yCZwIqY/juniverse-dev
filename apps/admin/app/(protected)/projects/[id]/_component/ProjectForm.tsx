...
import type { ProjectData, ProjectFormData } from 'apis';
...
const DEFAULT_CONTENT = [
  ...
  '<h2>주요 기능</h2>',
  '<ul><li>핵심 기능 1: 간략 설명</li><li>핵심 기능 2: 간략 설명</li><li>핵심 기능 3: 간략 설명</li></ul>',
  '<h2>기술 스택</h2>',
  '<h3>Frontend</h3>',
...
const ProjectForm = ({ initialProject, id, isNew }: ProjectFormProps) => {
  ...
  const form = useForm<ProjectFormData>({
    defaultValues: initialProject
      ? {
          ...
          position: initialProject.position ?? '',
          contribution: initialProject.contribution ?? '',
          ...
          images: [],
          isToy: initialProject.isToy ?? false,
          sourceCode: initialProject.sourceCode ?? {},
        }
      : {
          title: '',
          description: '',
